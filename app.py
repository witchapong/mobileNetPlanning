...
#
#     global filename4g
#     df = pci_rsi_planner.plan(int(plan_params_4g['rCol']),int(plan_params_4g['rMod3']),int(plan_params_4g['rMin']),socketio)
...
#     global filename3g
#
#     df = psc_planner.plan(int(plan_params_3g['rCol']),int(plan_params_3g['rMin']))
#     filename3g = '3g_plan_result.xlsx'
#     df.to_excel(filename3g,index=False)
#     socketio.emit('plan finished',{'dummy':'dummy'},namespace='/plan_3g')
